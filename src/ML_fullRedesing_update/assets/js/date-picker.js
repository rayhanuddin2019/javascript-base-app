$(function() {
    ...
    var datepicker = {
        container: $("#datepicker , #datepicker1, #booking_datepicker"),
        dateFormat: 'mm/dd/yy',
        dates: [null, null],
        status: null,
        inputs: {
            checkin: $('#checkin , #checkin1'),
    ...
    datepicker.container.datepicker({
        ...
        onSelect: function(dateText) {
            ...
            if (!datepicker.dates[0] || datepicker.dates[1] !== null) {
                ...
                $('#datepicker, #booking_datepicker').delegate('.ui-datepicker td', 'mouseover', function() {
                    ...
                    $('#datepicker td, #booking_datepicker td').each(function() {
    ...
    jQuery('.reset').click(function(e) {
        e.preventDefault();
        let datePicker = jQuery('#datepicker table.ui-datepicker-calendar td, #booking_datepicker table.ui-datepicker-calendar td');
        let datePickerA = jQuery('#datepicker table.ui-datepicker-calendar td a, #booking_datepicker table.ui-datepicker-calendar td a');
        ...
        datePicker.removeClass('ui-datepicker-highlight ui-checkin ui-checkout ui-datepicker-current-day')
        datePickerA.removeClass('ui-state-active')
    })
});